...
public class writeJson {
	...
	sps.add(new spell("Fire Strike", 11.5, new runes(2, 3, "mind")));
	sps.add(new spell("Fire Bolt", 22.5, new runes(3, 4, "chaos")));
	sps.add(new spell("Fire Blast", 34.5, new runes(4, 5, "death")));
	sps.add(new spell("Fire Wave", 42.5, new runes(5, 7, "blood")));
	sps.add(new spell("Fire Surge", 50.5, new runes(7, 10, "wrath")));
